...
pick_height['sawyer'].insert(0,-0.03)
place_height['sawyer'].insert(0,-0.1)
...
obj_namelists['abb'].insert(0,'bottle,soap')
pick_height['abb'].insert(0,-0.03)
