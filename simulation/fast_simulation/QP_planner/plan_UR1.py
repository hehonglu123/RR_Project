...
from ur_ik import ur_inv as inv
from general_robotics_toolbox import *      
   

def plan(robot,pd,angle, vel_ctrl, distance_inst,vacuum2, robot_idx, obj_vel=[0,0,0], capture_time=0):            #start and end configuration in joint space
