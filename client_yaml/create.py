...
client_ur = {"robot_name":"ur","height_offset":0.0,"obj_namelists":['toothpaste'],"home":[0.3,0.0,0.1],"pick_height":-0.03,"place_height":-0.1,"calibration_start":[-0.3,0.3,0.],"calibration_speed":-0.5,"url":'rr+tcp://bbb2.local:58652?service=ur_robot'}
client_sawyer = {"robot_name":"sawyer","height_offset":0.15,"obj_namelists":['bottle'],"home":[0.,0.3,0.3],"pick_height":-0.03,"place_height":-0.1,"calibration_start":[0.6,-0.2,0.15],"calibration_speed":0.05,"url":'rr+tcp://bbb1.local:58654?service=sawyer'}
