...
client_ur = {"robot_name":"ur","height":0.87,"obj_namelists":['tp'],"home":[-0.3,0.2,0.3],"pick_height":0.03,"place_height":0.11,"calibration_start":[-0.38,0.1,-0.07],"calibration_speed":0.07,"robot_command":"position_command","url":'rr+tcp://bbb2.local:58652?service=ur_robot'}
client_sawyer = {"robot_name":"sawyer","height":0.78,"obj_namelists":['bt','sp'],"home":[-0.1,0.3,0.3],"pick_height":0.105,"place_height":0.15,"calibration_start":[0.6,-0.2,0.155],"calibration_speed":0.05,"robot_command":"velocity_command","url":'rr+tcp://bbb1.local:58654?service=sawyer'}
