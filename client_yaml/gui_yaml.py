...
home['sawyer'].insert(0,'0.1,-0.7,0.2')
calibration_speed['sawyer'].insert(0,'0.02')
calibration_start['sawyer'].insert(0,'0.25,-0.7,0.06')
calibration_R['sawyer'].insert(0,'1.,0.,0.,0.,1.,0.,0.,0.,1.')
obj_namelists['sawyer'].insert(0,'sp,bt')
pick_height['sawyer'].insert(0,-0.01)
place_height['sawyer'].insert(0,-0.02)
...
label['sawyer'].grid(row=18,column=0)
...
label['abb'].grid(row=18,column=4)
